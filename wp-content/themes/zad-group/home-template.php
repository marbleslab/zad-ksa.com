...
?>
  ...
  <!-- Home brand sliders: 2 columns on desktop, stacked on smaller screens -->
  ...
  <section class="homeslider mb-5 pb-5">
    <div class="container">
      ...
      <div id="customSlider3" class="carousel slide carousel-fade">
        <div class="carousel-inner">
  ...
  <section class="homeslider2 my-5 py-5">
    ...
    <?php 
      ...
      if (!empty($slides2)) : ?>
      <div id="customSlider4" class="carousel slide carousel-fade">
        <div class="carousel-inner">
        <?php
          $item_count2 = 0;
          foreach ($slides2 as $index => $slide) : 
